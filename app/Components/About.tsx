...
const About = () => {
	...
	return (
		<div className="bg-gray-950">
			<div className="my-24 flex w-[60%] max-md:w-full min-h-[600px] text-white gap-28 mx-auto max-md:flex-col max-sm:gap-14 max-sm:my-16 max-custom:w-[80%] max-sm:px-6">

				<div className="relative h-full">
					<div className='border-4 z-10 border-gray-600 border-collapse h-[400px] w-full absolute -top-12 -right-7'></div>
					<Image src="/image.jpg" alt="Portfolio Image" width={1100} height={1100} className=' image saturate-50 opacity-70 w-[1200px] h-[400px]' />
				</div>
